...
if($verif == NULL){
    ...
    if($db->query($query)){
      ...
      redirect('v_jasprof.php?id='.$id_pengajuan, false);
    } else {
      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
          <strong>
            ...
            <span>Verifikasi Jasa Profesi</span>
          </strong>
        ...
        <div class="panel-body">
         ...
         <table class="table table-bordered table-striped">
           ...
           <tbody>
             ...
             <tr>
               <td class="text-center"><?php echo count_id();?></td>
               <td>SK disesuaikan dengan narsum yang hadir bagi jasa profesi</td>
                <td class="text-center">
             ...
             <tr>
               <td class="text-center"><?php echo count_id();?></td>
               <td>Jadwal Kegiatan/acara</td>
                <td class="text-center">
                 <?php if($verif['jadwal_kegiatan'] == 1){?>
                    <a href="proses_v.php?id=<?=$verif['id']?>&key=jadwal_kegiatan&p=batal" class="btn btn-danger">Batal</a>
                  <?php }else{ ?>
                    <a href="proses_v.php?id=<?=$verif['id']?>&key=jadwal_kegiatan&p=update" class="btn btn-success">Proses</a>
                  <?php } ?>
                </td>      
             </tr>  
             <tr>
               <td class="text-center"><?php echo count_id();?></td>
               <td>Absensi Narsum dan Peserta</td>
                <td class="text-center">
                 <?php if($verif['absensi'] == 1){?>
                    <a href="proses_v.php?id=<?=$verif['id']?>&key=absensi&p=batal" class="btn btn-danger">Batal</a>
                  <?php }else{ ?>
                    <a href="proses_v.php?id=<?=$verif['id']?>&key=absensi&p=update" class="btn btn-success">Proses</a>
                  <?php } ?>
                </td>      
             </tr> 
             <tr>
               <td class="text-center"><?php echo count_id();?></td>
               <td>Materi untuk paparan narsum</td>
                <td class="text-center">
                 <?php if($verif['materi_narsum'] == 1){?>
                    <a href="proses_v.php?id=<?=$verif['id']?>&key=materi_narsum&p=batal" class="btn btn-danger">Batal</a>
                  <?php }else{ ?>
                    <a href="proses_v.php?id=<?=$verif['id']?>&key=materi_narsum&p=update" class="btn btn-success">Proses</a>
                  <?php } ?>
                </td>      
             </tr>             
